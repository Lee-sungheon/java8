...
public class ActionEventsTest extends JFrame implements ActionListener{
	JButton jbtn1, jbtn2, jbtn3, jbtn4;
	
	public ActionEventsTest() {
		super("Action 처리");
...
//			}
	...
	public static void main(String[] args) {
		ActionEventsTest aet = new ActionEventsTest();
